...
public class MedicamentController implements Initializable {
    ...
    @FXML
    private TableView<MedicamentModel> table;
    @FXML
    private TableColumn<MedicamentModel, String> colnum;
    @FXML
    private TableColumn<MedicamentModel, String> coldesc;
    @FXML
    private TableColumn<MedicamentModel, String> colprix;
    @FXML
    private TableColumn<MedicamentModel, String> colqte;
    @FXML
    ...
    ObservableList<MedicamentModel> o = FXCollections.observableArrayList();
    ...
    public void getData() {
        ...
        try {
            ...
            while (rs.next()) {
                o.add(new MedicamentModel(rs.getInt("id"), rs.getString("description"), rs.getInt("prix"), rs.getInt("qte")));
    ...
    private void onModifier(ActionEvent event) {
        try {
            FXMLLoader fXMLLoader = new FXMLLoader();
            fXMLLoader.load(getClass().getResource("/vue/addMedic.fxml").openStream());
            AddMedicController cont = fXMLLoader.getController();
    ...
    private void onDelete(ActionEvent event) {
        try {
            PreparedStatement ps = con.prepareStatement("DELETE FROM `medicament` WHERE `id`=?");
    ...
    public void getData2() {
        table.getItems().clear();
        try {
            PreparedStatement ps = con.prepareStatement("SELECT * FROM `medicament` WHERE `description` like ?");
